...
The [cc.isr.tcp.vi] workbook includes the following worksheets:
...
[cc.isr.tcp.vi]: https://github.com/ATECoder/vba.iot.tcp/src/vi
...
[Testing]: ./cc.isr.tcp.vi.testing.md
